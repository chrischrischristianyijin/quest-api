...
class InsightsService:
    ...
    async def get_insights(
        ...
        try:
            ...
            query = supabase.table('insights').select(
                'id, title, description, url, image_url, created_at, updated_at, tags, stack_id, thought, insight_contents(summary)'
    ...
    async def get_insights_incremental(
        ...
        try:
            ...
            query = supabase.table('insights').select(
                'id, title, description, url, image_url, created_at, updated_at, tags, thought, insight_contents(summary)'
